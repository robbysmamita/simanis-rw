    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview"> <a href="#"> <i class="icon-home"></i> <span>Guru</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
                <ul class="treeview-menu">
                    <li><a href="<?= base_url('dashboard/index1') ?>"><i class="fa fa-angle-right"></i> Absensi</a></li>
                    <li><a href="<?= base_url('dashboard/index1') ?>"><i class="fa fa-angle-right"></i>Jadwal Pelajaran</a></li>
